...
;(function(window, document) {
  ...
  if (!navbarEl && titleEl) {
  	if(isOpenshift) {
      newNode.innerHTML = '<div class="navbar-header"><a href="/mhepburn/openshift-v3-workshop/0.%20Table%20of%20Contents.md.html" class="navbar-brand"></a></div><div class="navbar-collapse collapse"><ul class="nav navbar-nav navbar-right"><li class="hidden-xs hidden-sm"><a href="https://docs.openshift.com/" class="nav-sign-up" target="_blank">Documentation</a></li></ul></div>';
  	} else {
