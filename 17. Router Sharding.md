#**Lab 17: Create multiple routers using sharding to serve different projects**

Re: [openshift-sme] Multiple haproxy routers with different labels
...
In this lab we will deploy a clustered JBoss Enterprise Application Server with a simple web application that
