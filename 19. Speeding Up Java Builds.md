#**Lab 19: Speeding up Java Builds on OpenShift**

see virt:~/git/jorge-ose-notes/osev3/blog$ ls speed_java_builds.adoc

nexus, maven override, maven settings.xml file, incremental builds
